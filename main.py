...
# from model_V import LORA_V
from model import MGHFT
import utils
import collections


def get_args_parser():
    parser = argparse.ArgumentParser('MGHFT training and evaluation script', add_help=False)
    ...
    parser.add_argument('--save_name', default='tgfa', type=str)
...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.output_dir and utils.is_main_process():
            with (output_dir / "log_mg_05_fuset.txt").open("a") as f:
